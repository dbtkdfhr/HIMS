...
COMMENT ON COLUMN STORE_INVENTORY.IS_LOW_STOCK IS '안전재고 미달 여부: Y, N (자동계산)';
...
COMMENT ON COLUMN ORDER_REQUEST.ORDER_STATUS IS '발주 상태: REQUESTED, APPROVED, REJECTED, RECEIVED, CANCELED, DONE';
