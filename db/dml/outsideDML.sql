...
INSERT INTO EXTERNAL_ORDER_RECEIPT (EXTERNAL_ORDER_RECEIPT_ID,
                                    ...
                                    CREATED_AT,
                                    UPDATED_AT)
VALUES (1001, 601, 501, '1001', 'TIME 판교점', 20, 20, 'SHIPPED', '2026-05-01 00:00:00',
        '2026-05-01 00:00:00'),
       (1002, 601, 502, '1002', 'TIME 판교점', 15, 10, 'APPROVED', '2026-05-02 00:00:00',
        '2026-05-02 00:00:00'),
       (1003, 602, 503, '1003', 'SYSTEM 무역센터점', 10, 0, 'REJECTED', '2026-05-03 00:00:00',
        '2026-05-03 00:00:00'),
       (1004, 603, 504, '1004', 'MINE 더현대서울점', 12, 12, 'APPROVED', '2026-05-04 00:00:00',
        '2026-05-04 00:00:00'),
       (1005, 604, 505, '1005', 'THE CASHMERE 더현대서울점', 8, NULL, 'RECEIVED', '2026-05-05 00:00:00',
        NULL);
